...
-- data[2]	=>  Location: PIN_A10,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- data[3]	=>  Location: PIN_A9,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- data[4]	=>  Location: PIN_F11,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- data[5]	=>  Location: PIN_B9,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- data[6]	=>  Location: PIN_A11,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- data[7]	=>  Location: PIN_A13,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- data[8]	=>  Location: PIN_E9,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- data[9]	=>  Location: PIN_B13,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- data[10]	=>  Location: PIN_B8,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- data[11]	=>  Location: PIN_G11,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- data[12]	=>  Location: PIN_F10,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- data[13]	=>  Location: PIN_B10,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- data[14]	=>  Location: PIN_E11,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- data[15]	=>  Location: PIN_H9,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
...
-- output	=>  Location: PIN_H11,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
-- enable	=>  Location: PIN_H10,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
-- Hallsensor	=>  Location: PIN_C10,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
...
SIGNAL \TempCount~18_combout\ : std_logic;
...
-- Equation(s):
-- \Selector3~1_combout\ = (!\state.WaitLow~regout\ & (((!DelayCount(0)) # (!\state.DelayIn~regout\)) # (!DelayCount(1))))
...
-- Equation(s):
-- \Selector4~0_combout\ = (!\Hallsensor~combout\ & (((!\state.DelayIn~regout\) # (!DelayCount(0))) # (!DelayCount(1))))
...
-- Equation(s):
-- \Selector7~1_combout\ = (!\Hallsensor~combout\ & ((\state.DelayOut~regout\) # (\state.WaitHigh~regout\)))
...
-- Equation(s):
-- \state.DelayOut~0_combout\ = (\Selector7~2_combout\ & (((\state.DelayOut~regout\)))) # (!\Selector7~2_combout\ & (\state.WaitHigh~regout\ & (\Hallsensor~combout\)))
...
-- Equation(s):
-- \Selector5~1_combout\ = (!\Hallsensor~combout\ & ((\state.DelayOut~regout\) # ((\state.Measure~regout\) # (\state.WaitHigh~regout\))))
...
-- Equation(s):
-- \Selector3~0_combout\ = (\Hallsensor~combout\ & ((\state.WaitLow~regout\) # ((!DelayCount(1) & \state.DelayOut~regout\)))) # (!\Hallsensor~combout\ & (((!DelayCount(1) & \state.DelayOut~regout\))))
...
\TempCount~18\ : cycloneii_lcell_comb
-- Equation(s):
-- \TempCount~18_combout\ = (\state.Measure~regout\) # ((\UseTemp~regout\ & \output~combout\))
...
-- Equation(s):
-- \dataout~0_combout\ = (\UseTemp~regout\ & ((TempCount(0)))) # (!\UseTemp~regout\ & (TotalCount(0)))
...
-- Equation(s):
-- \dataout~2_combout\ = (\UseTemp~regout\ & (TempCount(1))) # (!\UseTemp~regout\ & ((TotalCount(1))))
...
-- Equation(s):
-- \dataout~3_combout\ = (\UseTemp~regout\ & (TempCount(2))) # (!\UseTemp~regout\ & ((TotalCount(2))))
...
-- Equation(s):
-- \dataout~4_combout\ = (\UseTemp~regout\ & ((TempCount(3)))) # (!\UseTemp~regout\ & (TotalCount(3)))
...
-- Equation(s):
-- \dataout~5_combout\ = (\UseTemp~regout\ & ((TempCount(4)))) # (!\UseTemp~regout\ & (TotalCount(4)))
...
-- Equation(s):
-- \dataout~6_combout\ = (\UseTemp~regout\ & ((TempCount(5)))) # (!\UseTemp~regout\ & (TotalCount(5)))
...
-- Equation(s):
-- \dataout~7_combout\ = (\UseTemp~regout\ & (TempCount(6))) # (!\UseTemp~regout\ & ((TotalCount(6))))
...
-- Equation(s):
-- \dataout~8_combout\ = (\UseTemp~regout\ & ((TempCount(7)))) # (!\UseTemp~regout\ & (TotalCount(7)))
...
-- Equation(s):
-- \dataout~9_combout\ = (\UseTemp~regout\ & (TempCount(8))) # (!\UseTemp~regout\ & ((TotalCount(8))))
...
-- Equation(s):
-- \dataout~10_combout\ = (\UseTemp~regout\ & (TempCount(9))) # (!\UseTemp~regout\ & ((TotalCount(9))))
...
-- Equation(s):
-- \dataout~11_combout\ = (\UseTemp~regout\ & (TempCount(10))) # (!\UseTemp~regout\ & ((TotalCount(10))))
...
-- Equation(s):
-- \dataout~12_combout\ = (\UseTemp~regout\ & (TempCount(11))) # (!\UseTemp~regout\ & ((TotalCount(11))))
...
-- Equation(s):
-- \dataout~13_combout\ = (\UseTemp~regout\ & (TempCount(12))) # (!\UseTemp~regout\ & ((TotalCount(12))))
...
-- Equation(s):
-- \dataout~14_combout\ = (\UseTemp~regout\ & (TempCount(13))) # (!\UseTemp~regout\ & ((TotalCount(13))))
...
-- Equation(s):
-- \dataout~15_combout\ = (\UseTemp~regout\ & (TempCount(14))) # (!\UseTemp~regout\ & ((TotalCount(14))))
...
-- Equation(s):
-- \dataout~16_combout\ = (\UseTemp~regout\ & (TempCount(15))) # (!\UseTemp~regout\ & ((TotalCount(15))))
